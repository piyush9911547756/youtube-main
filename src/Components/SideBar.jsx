...
const SideBar = ({ setCategory, sidebarOpen }) => {
  return (
    <>
      <div
  className="sidebar"
  style={{
    ...
    backgroundColor: "black",
      ...
      >
        <div className="side1">
          <div className="first">
            <div className="home" onClick={() => setCategory("All")}>
              <svg
            ...
            <div className="short" onClick={() => setCategory("Shorts")}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                height="24"
          ...
          <div className="second">
            ...
            <div className="channel">
              <div className="image1">
                <img src="./image/channels1.jpg" alt="" />
                <h3>We Are One</h3>
              </div>
              <div className="image1">
                <img src="./image/channels2.jpg" alt="" />
                <h3>Chai aur Code</h3>
              </div>
              <div className="image1">
                <img src="./image/channels3.jpg" alt="" />
                <h3>Amit Bhadana</h3>
              </div>
              <div className="image1">
                <img src="./image/channels4.jpg" alt="" />
                <h3>Tarak Mehta Ka...</h3>
              </div>
              <div className="image1">
                <img src="./image/channels5.jpg" alt="" />
                <h3>Codehal</h3>
              </div>
              <div className="image1">
                <img src="./image/channels6.jpg" alt="" />
                <h3>SEVENGERS</h3>
              </div>
              <div className="image1">
                <img src="./image/channels7.jpg" alt="" />
                <h3>Janvi Pandey</h3>
              </div>
            </div>
